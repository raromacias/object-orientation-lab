...
//Code Here
let{ color:carcolor, make:brand, model:type, year:release}=carDetails
...
//   }
// }
// let cat1 = new Cat("June", 2, "brown")
// let cat2 = new Cat("Meow", 5, "orange")
// cat1.print()
// cat2.print()
...
class Wizard {
  ...
  let merlin = new Wizard("Bill", 45, "teleport")
  // merlin.castSpell()
